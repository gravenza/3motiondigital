...
<script type="<?php echo base_url(); ?>/assets/application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
 <!-- Bootstrap Core CSS -->
...
<!-- jQuery -->
<link href='<?php echo base_url(); ?>/assets///fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
		...
		<!-- header-starts -->
								...
								<!--custom-widgets-->
												...
												<!--/candile-->
													<div class="candile"> 
															...
															vis.render();
																	...
																	<script type="<?php echo base_url(); ?>/assets/text/javascript" src="js/protovis-d3.2.js"></script>
																	<script type="<?php echo base_url(); ?>/assets/text/javascript" src="js/vix.js"></script>
									...
									<!--/charts-inner-->
									 ...
									 <!--footer section start-->
										<footer>
										   <p>&copy 2016 3Motion . PT Digital Kreasi Cakrawala | Design by <a href="https://3motion.co.id/" target="_blank">3Motion.</a></p>
										</footer>
									<!--footer section end-->
								</div>
							</div>
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>3MOTION</h1></span> 
			...
			<!--/down-->
							<div class="down">	
									  ...
									  <a href="index.html"><span class=" name-caret">PT. Digital Kreasi Cakrawala</span></a>
...
<script type="<?php echo base_url(); ?>/assets/text/javascript" src="<?php echo base_url(); ?>/assets/js/vroom.js"></script>
<script type="<?php echo base_url(); ?>/assets/text/javascript" src="<?php echo base_url(); ?>/assets/js/TweenLite.min.js"></script>
<script type="<?php echo base_url(); ?>/assets/text/javascript" src="<?php echo base_url(); ?>/assets/js/CSSPlugin.min.js"></script>
